...
if __name__ == '__main__':
    ...
    set_seed(traj_id)
    ''' 1. 准备数据 '''
    comp_data, _, prop_data, elem_feature_ep, elem_feature_bt = load_data(prop_id, 0)     # ~ 158 data points
    ...
    joblib.dump(
        (res_buff_comp, res_buff_ep),
        f'r2-comp-ep-{prop_id}-{f_n}-{traj_id}-{str(uuid.uuid4())[:8]}.pkl'
    )